import os  
print("\t\t\t welcom in new docker world")
print("this is my tui application which is help easy to understand the docker world")
...
while True:
    ...
    print(""" 
                              ...
                              DOCKER COMMAND IN EASY WAY USING TUI 
                             ======================================
  ...
  3.launch new os in docker 
  4. Installation of WordPress Site     
  ...
  Enter your option : """,end='')
    ...
    if(choice==1):
        ...
        if c==1:
            ...
            print("your system does not have docker ")
        continue
    elif(choice==4):
        infra_setup(choice)
        continue
...
def launch():
    os1=input("enter the name of the os image which container you want")
